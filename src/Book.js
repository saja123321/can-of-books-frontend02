          ...
          return (
            <Carousel.Item interval={2000}>
              ...
              <Carousel.Caption>
                ...
                <p style={{ width: '70%', opacity: '0.7', display: 'block', margin: '50px auto', backgroundColor: '#FCF0C8', color: '#630A10' }} >{b.description}</p>
                <Badge style={{ margin: '20px' }} bg="success">{b.status}</Badge>
